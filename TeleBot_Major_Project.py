...
updater = Updater(token='1334484856:AAH1UBHSZOkbpYETHJNkgA88dtMyCo2PLes', use_context=True)


dispatcher = updater.dispatcher

def start(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Hey! I'm a bot")

def stop(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Good Day! ")
...
def weatherInfo(update, context):
    ...
    response = req.get("https://api.openweathermap.org/data/2.5/weather?q=indore&appid=37643fffe08d4b8b453d5781ef356c29")
    ...
    # context.bot.send_message(chat_id=update.effective_chat.id, text="Humidity of indore is %s"%humidity)
